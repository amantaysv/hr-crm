...
- [ ] Баг: при создании вакансии кнопка сабмита не блокируется — двойной клик создаёт дубликат. Дизейблить кнопку на время отправки (и показывать состояние загрузки); то же проверить в форме отклика кандидата и в редактировании вакансии
- [ ] Список вакансий в админке (`/admin/vacancies`): сортировать так, чтобы закрытые вакансии шли после открытых
- [ ] Список вакансий в админке: показывать дату создания в карточке вакансии
